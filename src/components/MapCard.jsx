...
function MapCard({map}) {
  console.log(map)
  return (
    <div className=" h-40 w-44 grid grid-cols-2 grid-rows-2 relative">
      {/* Tags */}
      <div className="absolute top-2 px-2 flex items-center justify-between w-full">
        {map.highlighted && (
          <span className="uppercase text-white bg-orange-300 rounded px-1 py-[2px] font-extrabold text-[10px] tracking-widest">
            highlighted
          </span>
        )}
        <div className="">
